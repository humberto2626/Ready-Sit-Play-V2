<script lang="ts">
  ...
  function getNextTurn(current: 1 | 2 | 3): 1 | 2 | 3 {
...
Each player asks the canine player to "Give me" for 1 point, "Drop it" 2 points and "Leave it" for 3 points.
  ...
  function undoLastActivation() {
    ...
    if (type === 'challenge') {
      ...
      if (player === 1) {
        player1Cards = [...player1Cards, card as Card];
      } else if (player === 2) {
        player2Cards = [...player2Cards, card as Card];
      } else if (player === 3) {
        player3Cards = [...player3Cards, card as Card];
      }
      ...
      if (player === 1) {
        player1AdvantageCards = [...player1AdvantageCards, card as { id: string, message: string }];
      } else if (player === 2) {
        player2AdvantageCards = [...player2AdvantageCards, card as { id: string, message: string }];
      } else if (player === 3) {
        player3AdvantageCards = [...player3AdvantageCards, card as { id: string, message: string }];
      }
