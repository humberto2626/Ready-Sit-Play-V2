<script lang="ts">
  ...
  const actionInstructions: Record<string, string> = {
    ...
    'Place': `With a towel on the floor, guide ${dogName || 'your dog'} near it and drop a treat in the towel the moment they step on it, reward them.`
  };
  ...
  <div class="instructions-overlay">
    <div class="instructions-content">
      ...
      {#if currentStep === 3}
        ...
        <div class="instructions-section" style="--delay: 0.5s">
          <p>To Win: Be the first player to achieve and collect {player3Name.trim() ? 'four' : 'six'} Action Cards.</p>
